...
class Detail
    ...
    attr_accessor :genre, :title, :description, :link
    ...
    def movie_description
        ...
        puts "Movie Description : #{@@link[:description][-1]}"
    end
